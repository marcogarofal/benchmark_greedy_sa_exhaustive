...
class CombinationGraph:
    ...
    def filter_combinations_discretionary(self, weak_nodes, power_nodes_mandatory, power_nodes_discretionary, check_only_discretionary, check_no_mandatory):
        """
        Generator che yielda combinazioni valide invece di costruire lista
        ✅ Memory optimized: processa una combinazione alla volta
        ✅ SILENT: No prints
        """
        list_nodes_graph = self.graph.nodes()
        combinations_gen = combinations(self.all_possible_links, self._num_nodes_for_combinations)
